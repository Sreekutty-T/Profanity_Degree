...
d = [lines,Bad_Words, Bad_Word_Count, Total_Word_Count, Degree_of_Profanity]
export_data = zip_longest(*d, fillvalue = '')
with open('output.csv', 'w', encoding="ISO-8859-1", newline='') as myfile:
      wr = csv.writer(myfile)
      wr.writerow(("lines", "Bad_Words", "Bad_Word_Count","Total_Word_Count","Degree_of_Profanity"))
